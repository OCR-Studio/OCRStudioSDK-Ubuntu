...
#
# DESCRIPTION: 
#   This script is designed to locally build C# integration module for ocrstudiosdk library.
#
# MOTIVATION:
...
#   gcc/g++ - version 4.8.5 or higher. These are required for running OCRStudioSDK native
...
#   4. Check the sample: $ mono ocrstudiosdk_sample_cs.exe <path_to_image> <path_to_config*.ocr> [docmask]
#
# OVERVIEW:
